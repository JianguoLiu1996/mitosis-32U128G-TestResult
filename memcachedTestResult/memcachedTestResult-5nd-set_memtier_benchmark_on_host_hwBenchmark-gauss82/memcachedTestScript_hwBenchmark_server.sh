...
function startRedis(){
	# start memcached
	sudo memcached -d -m 16384 -p 7000 -u root -t 4 -l $SERVERADDR
	sudo memcached -d -m 16384 -p 7001 -u root -t 4 -l $SERVERADDR
	sudo memcached -d -m 16384 -p 7002 -u root -t 4 -l $SERVERADDR
	sudo memcached -d -m 16384 -p 7011 -u root -t 4 -l $SERVERADDR
	sudo memcached -d -m 16384 -p 7012 -u root -t 4 -l $SERVERADDR
	sudo memcached -d -m 16384 -p 7013 -u root -t 4 -l $SERVERADDR
	sudo memcached -d -m 16384 -p 7014 -u root -t 4 -l $SERVERADDR
	sudo memcached -d -m 16384 -p 7015 -u root -t 4 -l $SERVERADDR
	wait 
...
function startRedisWithPageReplication(){
	sudo numactl -r 0-3 memcached -d -m 16384 -p 7000 -u root -t 4 -l $SERVERADDR
        sudo numactl -r 0-3 memcached -d -m 16384 -p 7001 -u root -t 4 -l $SERVERADDR
        sudo numactl -r 0-3 memcached -d -m 16384 -p 7002 -u root -t 4 -l $SERVERADDR
        sudo numactl -r 0-3 memcached -d -m 16384 -p 7011 -u root -t 4 -l $SERVERADDR
        sudo numactl -r 0-3 memcached -d -m 16384 -p 7012 -u root -t 4 -l $SERVERADDR
        sudo numactl -r 0-3 memcached -d -m 16384 -p 7013 -u root -t 4 -l $SERVERADDR
        sudo numactl -r 0-3 memcached -d -m 16384 -p 7014 -u root -t 4 -l $SERVERADDR
        sudo numactl -r 0-3 memcached -d -m 16384 -p 7015 -u root -t 4 -l $SERVERADDR
	wait 
	ps auxf | grep memcached
	sleep 1s
