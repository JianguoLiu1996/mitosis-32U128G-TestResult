...
function startRedis(){
	# start memcached
	sudo numactl -C 6-7,14-15,22-23,30-31 memcached -d -m 122880 -p 6379 -u root -t 2
	wait 
...
function startRedisWithPageReplication(){
        sudo numactl -C 6-7,14-15,22-23,30-31 -r 0-3 memcached -d -m 122880 -p 6379 -u root -t 2
	wait 
	ps auxf | grep memcached
	sleep 1s
