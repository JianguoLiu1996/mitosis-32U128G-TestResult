...
function alltest(){
	...
	NUMBER=1nd
	rwtest
	OUTPUTPATH=../mysqlTestBysysbench_innodb_buffer_pool_size100GB_64_10M_F_OFF_2nd/
	NUMBER=2nd
	rwtest
	OUTPUTPATH=../mysqlTestBysysbench_innodb_buffer_pool_size100GB_64_10M_F_OFF_3nd/
        NUMBER=3nd
	rwtest
